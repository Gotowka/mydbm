...
subtitle: function(data) {
	const info = ['Encode Base64', 'Decode Base64'];
...
variableStorage: function(data, varType) {
	...
	const info2 = ['Base64 Encoded', 'Base64 Decoded'];
	...
	<div>
		<div class="embed" style="width:98%;">
			<embedleftline></embedleftline><div class="embedinfo">
				...
				<span class="embed-desc">${this.short_description}<br>Added in: ${this.version}<br>HTML & CSS by EliteArtz</span>
			</div>
		</div>
	</div>
	<div style="width: 35%;">
