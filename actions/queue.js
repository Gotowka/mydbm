module.exports = {
    ...
    meta: { version: "2.1.6", preciseCheck: true, author: 'Gotowka', authorUrl: 'https://github.com/Gotowka', downloadUrl: 'https://github.com/Gotowka/mydbm/blob/main/actions/queue.js' },
    ...
    html(isEvent, data) {
      ...
      <p>
          ...
          Variables:
          <span class="dbminputlabel">title, author, tracks, page, pages, thumbnail, duration</span>
      </p>
  </div><br>
  ...
  <store-in-variable dropdownLabel="Store In" selectId="storage" variableContainerId="varNameContainer2" variableInputId="varName2"></store-in-variable>`;
    ...
    async action(cache) {
      ...
      if (!interaction.member.voice.channel) return interaction.reply("You must join the voice channel!")
     ...
     this.storeValue(queueString, 1, 'tracks', cache);
