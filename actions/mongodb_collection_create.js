module.exports = {
    ...
    meta: { version: "3.1.1", preciseCheck: true, author: 'Gotowka', authorUrl: 'https://github.com/Gotowka', downloadUrl: 'https://github.com/Gotowka/mydbm/blob/v3/actions/mongodb_collection_create.js' },
  ...
  <div style="float: right; width: calc(50% - 12px);">
    ...
    async action(cache) {
      console.log('ACTION: mongodb_collection_create; [v1.0] (v3.1.1)')
