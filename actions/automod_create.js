module.exports = {
  ...
  html(isEvent, data) {
    ...
    <p>
        ...
        Variables:<br>
        <span class="dbminputlabel">error('create')</span>
    </p>
</div><br>
...
<dbm-checkbox id="alert" onchange="glob.changeType()" label="SendAlert"></dbm-checkbox>
  ...
  async action(cache) {
    console.log('\x1b[30m[\x1b[35mACTION\x1b[30m]: \x1b[33mautomod_create; \x1b[30m[\x1b[32mv1.3\x1b[30m] \x1b[30m(\x1b[36mv3.2.1\x1b[30m)\x1b[0m')
    ...
    if (functions.includes('delete')) settings.actions.push({ type: 1 })
    if (functions.includes('alert')) settings.actions.push({ type: 2, metadata: { channel: targetChannel } })
