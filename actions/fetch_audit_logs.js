    ...
    function get(i) {
      ...
      switch (i) {
          ...
          case 2:
           ...
           break;
          case 3:
           res = ["Changes", "Array<key, old, new>"];
           break;
          case 4:
           res = ["Reason", "String"];
           break;
          case 5:
           res = ["Extra", "Object<.../Role/GuildMember>"];
           break;
      }
      return res;
    }
...
<div style="padding-top: 8px; width: 100%;">
  ...
  async action(cache) {
    ...
    await cache.server.fetchAuditLogs({
      ...
      const map = ["Executor", "Id", "Target", "Changes", "Reason", "Extra"]
      const map2 = ["executor", "id", "target", "changes", "reason", "extra"]
      for (var i = 0; i < 6; i++) {
        this.storeValue(log[map2.at(i)], 1, map[i], cache)
      }
