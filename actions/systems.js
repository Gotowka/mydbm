module.exports = {
  ...
  meta: { version: "2.1.8", preciseCheck: true, author: 'Gotowka', authorUrl: 'https://github.com/Gotowka', downloadUrl: 'https://github.com/Gotowka/mydbm/blob/v2/actions/systems.js' },
...
`;
  ...
  async action(cache) {
    console.log('ACTION: systems; [v1.0] (v2.1.8)')
