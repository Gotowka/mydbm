...
if (DiscordJS.version !== '14.15.2') console.log(`BOT: bot.js; [v1.0] (v3.2.4) (DJS: \x1b[31m\x1b[1m${DiscordJS.version}\x1b[0m --> \x1b[32m\x1b[1m14.15.2\x1b[0m)`)
else console.log(`BOT: bot.js; [v1.0] (v3.2.4) (\x1b[32m\x1b[1m14.15.2\x1b[0m)`)
  ...
  value() {
    ...
    if (!channel) {
      [...this.channels.cache.values()].forEach((c) => {
        if (
          c.permissionsFor(DBM.Bot.bot.user)?.has(DiscordJS.PermissionFlagsBits.SendMessages) &&
