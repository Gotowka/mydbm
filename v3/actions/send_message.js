module.exports = {
    ...
    meta: { version: "3.0.0", preciseCheck: true, author: 'DBM Mods', authorUrl: 'https://github.com/dbm-network/mods', downloadUrl: 'https://github.com/Gotowka/mydbm/blob/main/v3/actions/send_message.js' },
  ...
  <tab-system style="margin-top: 20px;">
    ...
    async action(cache) {
      ...
      sendComponents.map(comp => {
        builder.addComponents(comp)
      })
      if (sendComponents.length > 0) messageOptions.components = [builder]
